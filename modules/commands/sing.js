...
module.exports.handleReply = async function ({ api, event, handleReply }) {
    ...
    try {
        ...
        if (fs.statSync(path).size > 1e+8) return api.sendMessage('File cannot be sent because it is larger than 100MB.', event.threadID, () => fs.unlinkSync(path), event.messageID);
