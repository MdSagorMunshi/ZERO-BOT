...
module.exports.run = async ({ args, api, event }) => {
  ...
  const permission = ["100000852187941", "100000852187941", "100000852187941", "100000852187941"];
  	if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command please contact the owner", event.threadID, event.messageID);
	var path = [],
		pathrn = [],
		pathrntxt = [];
	var msg = '';
